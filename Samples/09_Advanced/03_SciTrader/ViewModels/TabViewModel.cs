...
namespace SciTrader.ViewModels {
    public class TabViewModel : IDocumentContent {
        ...
        readonly HomeSymbolViewModel orderHistoryModel;
        readonly TradeHistoryViewModel tradeHistoryModel;
        readonly DomesticSymbolViewModel domesticSymbolModel;
        ...
        public HomeSymbolViewModel OrderHistoryModel { get { return orderHistoryModel; } }
        public TradeHistoryViewModel TradeHistoryModel { get { return tradeHistoryModel; } }
		public DomesticSymbolViewModel DomesticSymbolModel { get { return domesticSymbolModel; } }
        ...
        public TabViewModel(MarketDataProvider symbolProvider, SymbolData symbol) {
            ...
            orderHistoryModel = HomeSymbolViewModel.Create(dataProvider.OrdersHistoryDataSource);
			...
			domesticSymbolModel = DomesticSymbolViewModel.Create(symbolManager.OptionItems);
			Title = Symbol.Symbol;
        }
