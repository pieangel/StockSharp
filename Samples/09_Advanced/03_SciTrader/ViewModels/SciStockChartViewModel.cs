...
{
    public class SciStockChartViewModel : BaseViewModel
    {
        #region Fields
        ...
        private ObservableCollection<StockSymbol> _stockItems;
        private StockSymbol _selectedItem;
        ...
        public ObservableCollection<StockSymbol> StockItems
        {
        ...
        public StockSymbol SelectedItem
        {
        ...
        private void InitializeCollections()
        {
            ...
            StockItems = new ObservableCollection<StockSymbol>();
        }
        ...
        {
            if (parameter is StockSymbol selectedStockItem)
            {
                var chartDataManager = ChartDataManager.Instance;
                chartDataManager.requestChartData(SelectedItem.SymbolCode, SelectedChartType, SelectedCycle, 1500);
                _DataReceived = false;
            }
        }
        ...
        {
            var itemManager = SymbolManager.Instance;
            var stockItemsList = itemManager.GetFavoriteSymbolsByProductCode();
            StockItems = new ObservableCollection<StockSymbol>(stockItemsList);
