...
{    
    ...
    {
        private readonly SciStockChartViewModel _parentViewModel;
        ...
        protected BaseChartPaneViewModel(SciStockChartViewModel parentViewModel)
        {
        ...
        public SciStockChartViewModel ParentViewModel
        {
