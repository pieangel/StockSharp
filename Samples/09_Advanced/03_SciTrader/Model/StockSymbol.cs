...
namespace SciTrader.Model
{
    public class StockSymbol : INotifyPropertyChanged
    {
        ...
        private int _id = 0;
        private double _multiplier = 250000;
        ...
        {
            get => _symbolCode;
            set { _symbolCode = value; OnPropertyChanged(nameof(SymbolCode)); }
        }

		public string SymbolType
		{
			get => _symbolType;
			set { _symbolType = value; OnPropertyChanged(nameof(SymbolType)); }
		}
        ...
        {
            get => _multiplier;
            set { _multiplier = value; OnPropertyChanged(nameof(Multiplier)); }
        }
