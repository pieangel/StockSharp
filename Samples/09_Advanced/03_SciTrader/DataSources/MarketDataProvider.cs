...
namespace SciTrader.DataSources {
    public class MarketDataProvider {
        ...
        void LoadSymbolInfo() {
            Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream(DemoHelper.GetPath("SciTrader.Resources.", typeof(MarketDataProvider).Assembly) + "Symbols.xml");
            if (stream != null) {
